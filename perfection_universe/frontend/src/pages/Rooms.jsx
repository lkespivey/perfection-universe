      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{
          ...
          {rooms.map((room, i) => {
            ...
            const roomPage = ROOM_PAGES[room.slug]
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: active?.id === room.id
                    ? `0 0 40px ${room.ambient_color}22`
                    : 'none',
                }}
              >
                {/* Scar on last room */}
                ...
                <h3 style={{
                  ...
                  {room.name}
                  {isLast && (
                    <span style={{ marginLeft: '8px', fontSize: '0.6rem', color: 'rgba(255,80,80,0.6)' }}>⸻</span>
                  )}
                </h3>

                <p style={{
                  margin: '0 0 16px', fontSize: '0.88rem',
                  color: 'rgba(220,200,255,0.7)', lineHeight: 1.75,
                }}>
                  {room.description}
                </p>
                  ...
                  <AnimatePresence>
                    {active?.id === room.id && (
                      ...
                      >
                        <div style={{
                          paddingTop: '20px',
                          borderTop: `1px solid ${room.ambient_color}33`,
                        }}>
                          {room.unlock_requirement ? (
                            <p style={{
                              margin: 0, fontSize: '0.75rem',
                              letterSpacing: '0.12em', color: 'rgba(255,180,100,0.7)',
                            }}>
                            ...
                            <p style={{
                              margin: 0, fontSize: '0.75rem',
                              letterSpacing: '0.12em', color: 'rgba(100,255,180,0.7)',
                            }}>
                              ⬡ OPEN — ENTER FREELY
                            </p>
                          )}
